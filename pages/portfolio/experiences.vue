        ...
        <div class="max-w-custom-container mx-auto px-6 md:px-8">
          <div class="prose sm:prose-lg pb-12 md:pb-16">
            ...
            <p class="leading-8 sm:max-w-3xl">
              ...
              platform to help businesses like yours gain more visibility and
              grow. Let's have a chat and make this opportunity a reality!
            </p>
          ...
          >
            <div class="xl:col-span-2 prose sm:prose-lg">
              ...
              <p class="text-zinc-700 leading-8">
                ...
                incredible experiences we've had the pleasure of partnering with
                in the past. Join us, and let's make magic happen together!
              </p>
            </div>
            <ul
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    ...
                    visuals from the experience will create a direct link
                    between our followers and your business.
                  </p>
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    ...
                    of the experience, complete with visuals, so it's easy for
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    ...
                    immersive way to showcase your experience. Given the large
