          ...
          <div class="prose sm:prose-lg pb-12 md:pb-16">
            ...
            <p class="leading-8 sm:max-w-3xl">
              ...
              <a
                ...
                >@coupleofpatels</a
              >
              on Instagram. Our space is all about sharing the adventures and
              experiences we've gathered across the Midwest. We love using our
              platform to help promote stays like yours gain more visibility and
              increased traffic. Let's have a chat and make this opportunity a
              reality!
            </p>
        ...
        <section id="past-collabs">
          ...
          >
            <div class="xl:col-span-2 prose sm:prose-lg">
              ...
              <p class="leading-8">
                We're all about creating unforgettable moments and delivering
                unmatched value through our collaborations, all while making a
                positive impact on our audience. Check out some of the
                incredible stays we've had the pleasure of partnering with in
                the past. Join us, and let's make magic happen together!
              </p>
            </div>
            <ul
        ...
        <section id="our-rates">
          <div class="max-w-custom-container mx-auto px-6 md:px-8">
            <div class="-mt-4 md:-mt-0 pb-12 prose sm:prose-lg">
              ...
              <p class="leading-8 sm:max-w-3xl">
                We've put a lot of thought into our pricing to ensure it truly
                reflects our value to you and aligns with industry standards. To
                thank you for choosing us, we offer a special bonus: with every
                paid service, just let us know, and we'll provide you with
                copies of all the photos and videos we've captured.
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    Increase your traffic with our story slides! Our captivating
                    visuals from the accomodation will create a direct link
                    between our followers and your stay.
                  </p>
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    Up your traffic with our post! We craft a detailed overview
                    of the accomodation, complete with visuals, so it's easy for
                    both new and returning followers to explore at any time.
                  </p>
                  <div class="flex items-center gap-x-4 mt-6">
                    <h4
                      class="flex-none text-sm text-primary font-semibold leading-6"
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    ...
                    immersive way to showcase your stay. Given the large number
                    of targeted views we receive on reels, they are a prime
                    choice for getting the right kind of exposure.
                  </p>
                  <div class="flex items-center gap-x-4 mt-6">
                    <h4
                      class="flex-none text-sm text-primary font-semibold leading-6"
            ...
            <p class="text-base mt-10 max-w-3xl">
              <i
                >*We also offer personalized packages with discounts. If you're
