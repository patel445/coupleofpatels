        ...
        <div class="max-w-custom-container mx-auto px-6 md:px-8">
          <div class="prose sm:prose-lg pb-12 md:pb-16">
            ...
            <p class="leading-8 sm:max-w-3xl">
              ...
              platform to help businesses like yours increase sales and grow.
              Let's have a chat and make this opportunity a reality!
            </p>
          ...
          >
            <div class="xl:col-span-2 prose sm:prose-lg">
              ...
              <p class="leading-8">
                ...
                incredible brands we've had the pleasure of partnering with in
            ...
            >
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    ...
                    visuals of your product will create a direct link between
                    our followers and your brand.
                  </p>
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    Up your sales with our post! We seamlessly integrate your
                    product into our content, complete with visuals and a link,
                    making it easy for both new and returning followers to
              ...
              >
                <div class="lg:flex-auto p-8 lg:p-10">
                  ...
                  <p class="mt-6 text-base leading-7 text-zinc-700">
                    ...
                    immersive way to showcase your product. Given the large
